...
export function exportSceneToGLTF(scene: THREE.Scene, filename = 'SeminarHall_DigitalTwin.glb') {
  const exporter = new GLTFExporter();

  // Create a clean clone group without helper lines or cameras
...
export function exportSceneJSONSchema(scene: THREE.Scene) {
  const schema = {
