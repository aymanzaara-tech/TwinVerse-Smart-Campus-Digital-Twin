...
import { sampleApiSnippet } from '../../utils/digitaltwin/digitalTwinApi.js';

export const ApiSandboxModal = ({
  isOpen,
  onClose,
  onRunLightingTest,
  onRunSlideTest,
        ...
        <div className="p-6 grid grid-cols-1 lg:grid-cols-2 gap-6 overflow-y-auto max-h-[75vh]">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-slate-300">SDK Usage Example (JS)</span>
              <button
                onClick={handleCopy}
