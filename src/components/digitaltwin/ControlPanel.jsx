...
export const ControlPanel = ({
  ...
  return (
    <>
      ...
      <div className="absolute top-20 left-4 z-20 w-88 max-h-[calc(100vh-14rem)] flex flex-col bg-slate-900/90 backdrop-blur-xl border border-slate-700/60 rounded-2xl shadow-2xl overflow-hidden transition-all duration-300">
        {/* Panel Header */}
        ...
        {!isCollapsed && (
          <>
            {/* Tab Navigation */}
            <div className="grid grid-cols-4 p-1.5 bg-slate-950/40 border-b border-slate-800 text-xs">
              <button
            ...
            {/* Tab Contents */}
            <div className="p-4 space-y-4 overflow-y-auto max-h-[calc(100vh-20rem)] text-xs text-slate-300">
